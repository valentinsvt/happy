...
<%@ page import="happy.tramites.Direccion" %>
<!DOCTYPE html>
<html>
    <head>
        <meta name="layout" content="main">
        <title>Lista de Direccion</title>
    </head>
    <body>
        ...
        <table class="table table-condensed table-bordered table-striped">
            ...
            <g:each in="${direccionInstanceList}" status="i" var="direccionInstance">
                <tr data-id="${direccionInstance.id}">
        ...
        <elm:pagination total="${direccionInstanceCount}" params="${params}"/>
        ...
        <script type="text/javascript">
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Direccion seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
