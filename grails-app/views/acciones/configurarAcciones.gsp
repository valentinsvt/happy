<%@ page import="happy.seguridad.Prfl; happy.seguridad.Accn;happy.seguridad.Tpac;" contentType="text/html;charset=UTF-8" %>
<html>
<head>
                ...
                <table style="width: 600px;" id="tabla_${mod.id}">
                    ...
                    <g:each in="${Accn.findAllByModuloAndTipo(mod,Tpac.get(tipo_tpac),[sort:'control'])}" var="accn"
                        ...
                        <tr class="${(j % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${accn.control}</td>
                            <td><g:select from="${happy.seguridad.Tpac.list()}" optionKey="id" accn="${accn.id}"
                                          name="accn"
